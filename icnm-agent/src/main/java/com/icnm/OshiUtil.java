...
public class OshiUtil {
     ...
     * @throws Exception
     */
    public static com.icnm.entity.SystemInfo os(CentralProcessor processor, OperatingSystem os) throws Exception {
        com.icnm.entity.SystemInfo systemInfo = new com.icnm.entity.SystemInfo();
     ...
     * @return
     */
    public static SysLoadState getLoadState(com.icnm.entity.SystemInfo systemInfo, CentralProcessor processor) throws Exception {
